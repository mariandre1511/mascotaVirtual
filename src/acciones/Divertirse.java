...
public class Divertirse {
    ...
    public void entretenerseCon (EntretenimientosEnum entretenimiento, Mascota mascota){
        ...
        if(nivelOriginal != 0){
            ...
            System.out.println("duke acabaa de entretenerse con " + entretenimiento + " y su aburrimiento que estaba en " + nivelOriginal + " descendio a " + mascota.getNivelAburrimiento());
    ...
    public void entretenerseCon(Divertirse divertirse, Mascota aThis) {
